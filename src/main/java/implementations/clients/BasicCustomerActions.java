...
//        try {
//            var flight = handler.findFlightById(desiredFlight.getFlightID());
//
//            if (flight.getAvailableSeatsNumber() > 0) {
//                var bought = handler.addTicket(flight.getFlightID(), price, documentId);
//
//                if (!bought) {
//                    var errorMessage = """
